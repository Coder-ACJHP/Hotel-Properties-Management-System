...
public class RezervationsFrame extends JPanel {
	...
	public RezervationsFrame() {
		...
		findBtn.setIcon(new ImageIcon(RezervationsFrame.class.getResource("/com/coder/hms/icons/main_find.png")));
				...
				if(agencyRefField.getText().length() > 0) {
					...
					ce.setTime(endDate);
						...
						//other odds
							...
							//here get the all reservations in this date.
