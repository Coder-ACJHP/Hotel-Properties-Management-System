...
public class CustomExchange extends JDialog {
	...
	public CustomExchange() {
		...
		btnUpdate.setIcon(new ImageIcon(CustomExchange.class.getResource("/com/coder/hms/icons/menubar_exchange_calculate.png")));
