...
public class Main_ChangePassword extends JDialog {
	...
	public Main_ChangePassword() {
		...
		btnUpdate.setIcon(new ImageIcon(LoginExternalWindow.class.getResource("/com/coder/hms/icons/login_key.png")));
