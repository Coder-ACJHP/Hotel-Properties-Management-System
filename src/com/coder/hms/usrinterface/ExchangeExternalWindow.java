...
public class ExchangeExternalWindow extends JDialog {
	...
	public ExchangeExternalWindow() {
		...
		btnUpdate.setIcon(new ImageIcon(ExchangeExternalWindow.class.getResource("/com/coder/hms/icons/menubar_exchange_calculate.png")));
