...
public class NewReservExternalWindow extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public NewReservExternalWindow() {
		...
		chancelBtn.setIcon(new ImageIcon(NewReservExternalWindow.class.getResource("/com/coder/hms/icons/login_clear.png")));
		...
		btnNewButton.setIcon(new ImageIcon(NewReservExternalWindow.class.getResource("/com/coder/hms/icons/newReserv_payment.png")));
		btnNewButton.setSelectedIcon(new ImageIcon(NewReservExternalWindow.class.getResource("/com/coder/hms/icons/newReserv_payment.png")));
