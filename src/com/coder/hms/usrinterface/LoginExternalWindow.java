 ...
 *
 */
public class LoginExternalWindow extends JDialog {
	...
	public LoginExternalWindow() {
		...
		*/
		...
		btnLogin.setIcon(new ImageIcon(LoginExternalWindow.class.getResource("/com/coder/hms/icons/login_key.png")));
