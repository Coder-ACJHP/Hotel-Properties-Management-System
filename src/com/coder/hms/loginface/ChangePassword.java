package com.coder.hms.loginface;
...
public class ChangePassword extends JDialog {
	...
	public ChangePassword() {
		...
		btnUpdate.setIcon(new ImageIcon(LoginFrame.class.getResource("/com/coder/hms/icons/login_key.png")));
		...
		setPasswordVisible
				.setIcon(new ImageIcon(ChangePassword.class.getResource("/com/coder/hms/icons/login_show_pwd.png")));
